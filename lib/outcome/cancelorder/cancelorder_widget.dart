  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CartRecord> cancelorderCartRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final cancelorderCartRecord = cancelorderCartRecordList.isNotEmpty
            ? cancelorderCartRecordList.first
            : null;
          ...
          child: Scaffold(
            ...
            appBar: PreferredSize(
              ...
              child: AppBar(
                ...
                title: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(77.0, 20.0, 0.0, 0.0),
                  child: Text(
                    'Cancel order',
                ...
                children: [
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            20.0, 20.0, 20.0, 0.0),
                        child: Text(
                          'Sorry to see you cancel. Please tell us the reason, and we will try to make your next order experience better! ',
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: '    Please tell us the reason. ',
                            labelStyle:
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await cancelorderCartRecord!.reference.delete();

                        await FeedbackRecord.collection
                            .doc()
                            .set(createFeedbackRecordData(
                              cancelreason: _model.textController.text,
                            ));
