...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Drypage',
          path: '/drypage',
          builder: (context, params) => const DrypageWidget(),
        ),
        FFRoute(
          name: 'order',
          path: '/order',
        ...
        FFRoute(
          name: 'Washpage',
          path: '/washpage',
          builder: (context, params) => const WashpageWidget(),
        ),
        FFRoute(
          name: 'Washanddrypage',
          path: '/washanddrypage',
          builder: (context, params) => const WashanddrypageWidget(),
        ),
        FFRoute(
          name: 'payment',
          path: '/payment',
        ...
        FFRoute(
          name: 'livelocation',
          path: '/livelocation',
          builder: (context, params) => const LivelocationWidget(),
        ),
        FFRoute(
          name: 'orderplaced',
          path: '/orderplaced',
          builder: (context, params) => const OrderplacedWidget(),
        ),
        FFRoute(
          name: 'cancelorder',
          path: '/cancelorder',
          builder: (context, params) => const CancelorderWidget(),
        )
