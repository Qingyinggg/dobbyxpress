...
import 'washanddrypage_model.dart';
export 'washanddrypage_model.dart';

class WashanddrypageWidget extends StatefulWidget {
  const WashanddrypageWidget({super.key});

  @override
  _WashanddrypageWidgetState createState() => _WashanddrypageWidgetState();
}

class _WashanddrypageWidgetState extends State<WashanddrypageWidget> {
  late WashanddrypageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WashanddrypageModel());
  }
            ...
            Align(
              ...
              child: Column(
                ...
                children: [
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    ...
                                    onChanged: (val) async {
                                      ...
                                      if (_model.choiceChipsValue1 == '1 bag') {
                                        setState(() {
                                          FFAppState().price = 10.0;
                                        });
                                      } else {
                                        if (_model.choiceChipsValue1 ==
                                            '2 bags') {
                                          setState(() {
                                            FFAppState().price = 12.0;
                                          });
                                        } else {
                                          setState(() {
                                            FFAppState().price = 14.0;
                                          });
                                        }
                                      }
                                    },
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(101.0, 30.0, 0.0, 0.0),
                    child: Container(
                      width: 180.0,
                      height: 47.0,
                      decoration: BoxDecoration(
              ...
              child: Container(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    setState(() {
                      FFAppState().service = 'Wash and Dry';
