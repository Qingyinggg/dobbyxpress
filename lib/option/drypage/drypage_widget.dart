...
import 'drypage_model.dart';
export 'drypage_model.dart';

class DrypageWidget extends StatefulWidget {
  const DrypageWidget({super.key});

  @override
  _DrypageWidgetState createState() => _DrypageWidgetState();
}

class _DrypageWidgetState extends State<DrypageWidget> {
  late DrypageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrypageModel());
  }
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Align(
              alignment: const AlignmentDirectional(0.00, 0.16),
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(78.0, 0.0, 0.0, 0.0),
                      child: Container(
                        width: 180.0,
                        height: 47.0,
                        decoration: BoxDecoration(
